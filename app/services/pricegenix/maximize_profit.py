"""
PRICEGENIX - MAXIMIZE PROFIT
⚠️ EXACT LOGIC FROM maximize_profit.py
"""
...
def run_maximize_profit_optimization(request_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    MAXIMIZE TOTAL PROFIT (₹)
    Objective: max(p1 + p2 + p3 + p4 + p5 + p6)
    """
