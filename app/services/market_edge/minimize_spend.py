"""
MINIMIZE SPEND OPTIMIZATION
⚠️ EXACT LOGIC FROM minimize_spend_marketing.py
"""
...
def run_minimize_spend_optimization(request_data: Dict[str, Any]) -> Dict[str, Any]:
    """
    ...
    for x1 in x1_vals:
        for x2 in x2_vals:
            for x3 in x3_vals:
                ...
                if result["total_spend"] < best["spend"]:
                    best = {
    ...
    return {
        "status": "success",
        "message": "Optimal solution found - Total Spend minimized",
        "objective": "minimize_spend",
